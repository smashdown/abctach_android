...
public class ImageInputHelper {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == REQUEST_PICTURE_FROM_GALLERY) && (resultCode == Activity.RESULT_OK)) {
            ...
            Log.d(TAG, "Image selected from gallery - data=" + data.getData());
    ...
    public void takePhotoWithCamera() {
        ...
        try {
            ...
            tempUriFromSource = FileProvider.getUriForFile(mContext, "com.abctech.blogtalking.fileprovider", tempFileFromSource);
        } catch (IOException e) {
            e.printStackTrace();
        }
