...
public class BTScrollingFABBehavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
    private int toolbarHeight;

    public BTScrollingFABBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
