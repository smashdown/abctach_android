package com.abctech.blogtalking.module.imagepicker.util;
...
public class MediaStoreImageUtil {
    ...
    static public List<HSImageFolderItem> getBucketList(Context context) {
        ...
        Log.i("JJY", " query count=" + cur.getCount());
        ...
        if (cur.moveToFirst()) {
            ...
            do {
                ...
                Log.i("JJY", " bucket=" + folderItem.bucketDisplayName + "  dateTaken=" + folderItem.lastDateTaken + "  _data=" + folderItem.lastData);
